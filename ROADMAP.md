...
- [x] **Create Quiz** → BzmPageTitle, BzmCard, BzmQuestionEditor, BzmErrorMessage, BzmActionBar, BzmButton
- [x] **Host Lobby** → BzmPageTitle, BzmCard, BzmRoomCode, BzmPlayerList, BzmButton
...
- [x] **Player Game** → BzmCountdownView, BzmProgressBar, BzmQuestionHeader, BzmAnswerGrid, BzmAnswerFeedback, BzmScoreDisplay, BzmWaitingState
- [x] **Player Results** → BzmCard, BzmScoreDisplay, BzmLeaderboard, BzmButton
- [x] **App Shell** → BzmComicBackground

## Phase 5: Cleanup

- [x] Delete `apps/client/src/app/components/` (moved to `@bazam/ui`)
- [x] Delete `apps/client/src/web-components/` (replaced by BzmTimer, BzmProgressBar, BzmAvatar)
- [x] Move `animate-in`, `animate-scale` utility classes into UI components
- [x] Audit `styles.css` for dead CSS (`.card` class, etc.)
